...
using CommunityHeart.ViewModels;
using CommunityHeart.Views;
using System;
...
namespace CommunityHeart.WindowsPhone
{
    /// <summary>
...
#endif
            IoC.Instance.Register<INavigationService>(new NavigationService());
